  ...
  return (
    <>
      ...
      <div className=" font-lexend ml-6 mt-6 space-y-2">
        <h4 class="self-center text-xl font-lexend font-normal whitespace-nowrap text-white  ">
          Profile Info
        </h4>
        {/* Email */}
        <div className="flex gap-4 items-center">
          ...
          <div>
            {" "}
            <h4 class=" text-base font-normal font-lexend whitespace-nowrap text-white  ">
              Email
            </h4>
          </div>
        </div>
