      ...
      <div class=" p-5 ml-4 mb-1 ">
        <div class=" flex flex-wrap justify-between items-center  ">
          <div class="flex items-center">
            <span class="self-center text-3xl font-semibold whitespace-nowrap dark:text-white font-satoshi text-white">
              {props.title}
            </span>
            {props.viewlist === true ? (
              <a
              href="/traningdrill/alldrills"
                class="inline-flex font-lexend items-center py-2 px-3 ml-10 text-sm font-normal text-white bg-green-500 rounded-[4px] "
              >
                View in list
              </a>
            ) : (
            ...
            {props.Preview === true ? (
              <a
                href="/traningdrill"
                class="inline-flex items-center py-2 px-3 ml-10 text-sm font-normal text-white bg-green-500 rounded-[4px] "
              >
                Preview
              </a>
            ) : (
