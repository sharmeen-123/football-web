      ...
      <div className="mx-[22px] ">
        <div class=" px-7 pt-8 pb-6 font-lexend lg:w-full 2xl:w-[880px] min-w-sm text-center bg-[#212121] rounded-lg  ">
          <div className=" gap-5 flex mt-2">
            ...
            <input
              type="text"
              class="w-full bg-[#1A1A1A] font-lexend  text-white text-sm font-normal rounded-lg block  pl-7 py-2.5  placeholder-gray-400 "
          ...
          <div className="mt-5">
            <div className="flex ml-14 ">
              <button
                ...
                class="inline-flex ml-1   py-2 px-4 text-sm font-normal text-white bg-[#191919] rounded-2xl "
              >
                <svg
                  className="mr-3"
                  width="18"
              ...
              <button
                ...
                class="inline-flex  py-2 ml-[15px] px-4 text-sm font-normal text-white bg-[#191919] rounded-2xl"
              >
                <svg
                  className="mr-3"
                  width="22"
