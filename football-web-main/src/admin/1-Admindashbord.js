        ...
        <div class="relative p-4 w-full max-w-lg  ">
          <div class="relative bg-gradient-to-r from-[#000000]/24 to-[#000000]/81 backdrop-blur-[5px]  border-[border] border-2   rounded-2xl px-4 py-2">
            ...
            <div class="flex justify-center p-3 ">
              <input
                type="number"
                class="bg-[#808080]  text-white text-sm rounded-lg  block  pl-10 p-2.5 mb-5 placeholder-white"
                placeholder="Day"
                required=""
                min={1}
                max = {31}
              ...
              <input
                type="number"
                class="bg-[#808080]  text-white text-sm rounded-lg  block  pl-10 p-2.5 mb-5 ml-3 placeholder-white"
                placeholder="Month"
                required=""
                min={1}
                max = {12}
