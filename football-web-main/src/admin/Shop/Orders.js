          ...
          <div className="w-full pr-12">
            ...
            <div className="flex">
                ...
                <form class="flex items-center w-1/2 ml-9 mt-4">
                 ...
                 <button
                    type="submit"
                    class=" font-dm  items-center py-2 px-5 ml-4 text-sm font-normal bg-[#E7E7E7] rounded-[4px] "
                    >
                        <div className="flex">
                 ...
                 <button
                    type="submit"
                    class=" font-dm items-center py-2 px-5 ml-4 text-sm font-normal text-white bg-green-500 rounded-[4px] "
                    >
                    Done
                    </button>
                 </div>
...
{/* Latest Orders  */}
      ...
      <table class="font-dm w-full text-md text-center justify-items-center text-white items-center">
            <thead class=" font-dm text-base font-normal text-[#fffff]/0.81 uppercase border-b border-[#7E7E7E]  border-b">
            ...
            >
                ...
                <tr class="font-dm text-center border-b border-b border-[#7E7E7E] justify-items-center">
                <th
                  scope="row"
                  class="py-4 px-3 font-medium whitespace-nowrap text-white"
                >
                ...
                <td class="py-4 ">
                <button
              class="font-dm text-black bg-white m-4 text-sm  w-40  justify-center focus:outline-none font-normal rounded-[4px]  px-4 py-2 text-center inline-flex items-center"
              type="button"
          >
                  Paid
              </button>
