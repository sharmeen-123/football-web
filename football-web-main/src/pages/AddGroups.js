        ...
        <div className="flex divide-x">
          <div className="w-10/12 ml-8 mt-8  font-lexend">
            ...
            <div className="flex gap-5 items-center">
              <input
                type="text"
                class="bg-[#212121] font-lexend font-normal  text-gray-500 text-sm rounded-md w-1/2 pl-6 p-2.5  placeholder-gray-400"
                placeholder="Group name"
                required=""
              />
              <div
                onClick={handleClick}
                className="cursor-pointer font-lexend flex items-center gap-5 py-2.5 px-4 text-white/80 text-xs rounded-md  bg-[#212121]"
              >
                <svg
                  width="20"
                  height="20"
