  ...
  return (
    <>
      <div className="flex-col w-full ">
        ...
        {/* Title Of the Page */}
        <h4 class="font-lexend self-center text-xl font-medium whitespace-nowrap text-white mx-9 mt-8 mb-[26] ">
          Skills Evaluations
        </h4>
        {/* Search Button  */}
        <div className="flex items-center justify-start gap-10 mx-10 my-5 font-dm">
          <form class="flex items-center w-1/2 font-dm">
            ...
            <button
              type="submit"
              class="font-lexend inline-flex items-center py-2.5 px-5 ml-2 text-sm font-normal text-white bg-green-500 rounded-[4px] "
            >
              Search
            </button>
          </form>
          ...
          <button
            class="text-white bg-green-500 ml-auto  focus:outline-none font-normal rounded-[4px] text-sm px-4 py-2 text-center inline-flex items-center"
            type="button"
          >
            Mental Skills
            <svg
          ...
          <button
            ...
            class="text-white bg-green-500 ml-2   focus:outline-none font-normal rounded-[4px] text-sm px-4 py-2 text-center inline-flex items-center"
            type="button"
          >
            Group
            <svg
        ...
        <div className="flex items-center  mx-10 my-5 font-dm">
          ...
          <button
            type="button"
            class="text-black bg-white ml-9 font-dm  font-normal rounded-[4px] text-base px-9 py-[6px] mr-2 "
          >
            Mark Done
          </button>
        ...
        {/* Table Of user  */}
        <div class="overflow-x-auto relative mx-10 my-5 font-dm rounded-xl">
          <table class="w-full text-sm text-left  text-gray-400 bg-gradient-to-r from-[#212A39]/100 to-[#3A3A3A]/20 ">
            <thead class="text-sm font-normal  font-dm  text-[#ffffff]/80   border-b">
              <tr className="text-center  ">
                <th scope="col" class="pt-5 pb-3 px-6">
                  Player Name
                </th>
                <th scope="col" class="pt-5 pb-3 px-6">
                  Confidence
            ...
            <tbody>
              {staticdata.map((val, ind) => (
                <tr class=" font-dm border-b  border-gray-700 text-center">
                  <th
                    scope="row"
                  ...
                  <td>
                    <textarea
                      cols="40"
                      class="block p-2.5 w-full text-sm text-white bg-[#0C0E14] rounded-[4px] placeholder:text-gray-400 "
