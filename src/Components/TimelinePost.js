  ...
  return (
    <div className="">
      <div className=" mx-[22px] my-10  ">
        ...
        {post === false ? (<></>) : (<>
            {post.map ((val, ind) => {
              <div className="text-white">{val.post.email}</div>
            })}
...
{/* if post is image */}
              ...
              <div className="flex font-lexend mt-1  items-center gap-4">
                ...
                {val.post.date === date ? (<>
                      {val.post.time === time ? (<>
                        ...
                        <h5 class="
                         text-sm font-light tracking-tight text-white">
                        Today {val.post.time}
                        </h5>
          ...
          <img className="mt-5 px-2 w-full rounded-md" src={val.post.image}  />
          </div>
