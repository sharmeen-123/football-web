    ...
    <>
      <div className="flex-col w-full">
        ...
        <div className="flex items-center justify-between mt-[32px]  mr-10">
          <h4 class="self-center text-xl font-medium text-white font-lexend whitespace-nowrap  ml-9 ">
            All Groups
          </h4>
          <div className="flex">
          <input
          ...
          <div className=" space-x-4 mr-9">
            <button
              type="submit"
              class="inline-flex items-center py-2.5 px-6 font-lexend  text-sm font-normal text-white bg-green-500 rounded-[4px] "
            >
              Search
            </button>
            <NavLink to={"/newsfeed/addgroups"}>
            <a
              href="/newsfeed/addgroups"
              class="inline-flex items-center  py-2.5 px-6  text-sm font-lexend font-normal text-black bg-white rounded-[4px] "
            >
              New Group
            </a>
            </NavLink>
        ...
        <div className="mb-9 mt-12 mx-9 font-sans grid lg:grid-cols-4 2xl:grid-cols-5 gap-5 ">
          ...
          {/* map all groups if groups exists*/}
                  {staticdata === false? (<></>) : (<>
                    {staticdata.map((value, ind) => (
              <>
            <NavLink to={"/selectgroup/groups"}
                            onClick = {() => setActiveGroup(value._id)}>
            <div class=" font-dm p-3 mb-6 max-w-xs bg-[#212121] rounded-lg h-30"
            onClick = {() => setActiveGroup(value._id)}>
              <div className="flex gap-4 items-center">
                <img src={value.pic}
                className="rounded-lg h-20 w-20"/>
                <div>
                  <h5 class="mb-2 font-dm text-lg font-normal tracking-tight text-white">
                    {value.name}
                  </h5>
                  <div className="flex items-center gap-3">
                    ...
                    <p class="font-normal font-dm text-sm  text-gray-400">
