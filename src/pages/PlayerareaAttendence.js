  ...
  return (
    <>
      <div className="flex-col w-full">
        ...
        {/* Title Of the Page */}
        <h4 class="self-center text-xl font-medium text-white font-lexend whitespace-nowrap  ml-9 mt-[32px] ">
          Attendance
        </h4>
        {/* Search Button  */}
        <div className="flex items-center justify-start gap-10 mx-9 my-5 font-dm">
          <form class="flex items-center w-1/2">
            ...
            <button
              type="submit"
              class="inline-flex font-dm items-center py-2 px-5 ml-4 text-sm font-normal text-white bg-green-500 rounded-[4px] "
            >
              Search
            </button>
          ...
          <button
            class="text-white font-dm bg-green-500 ml-auto text-sm  focus:outline-none font-normal rounded-[4px]  px-4 py-2 text-center inline-flex items-center"
            type="button"
          >
           Group
            <svg
        ...
        <div class="overflow-x-auto   font-lexend relative mx-10 my-5 font-dm rounded-xl">
          <table class="font-dm w-full text-sm text-left text-gray-500  bg-gradient-to-r from-[#212A39]/100 to-[#3A3A3A]/0 ">
            <thead class=" font-dm text-base font-normal text-[#fffff]/0.81 uppercase  border-b">
              <tr className="text-center ">
                ...
                <th scope="col" class="py-3 pl-[256px]">
                  Status
                </th>
            ...
            <tbody>
              {staticdata.map((val, ind) => (
                <tr class="font-dm border-bbg-gray-800 border-gray-700 text-center">
                  <th
                    scope="row"
                  ...
                  <td class="py-4 pl-[254px]">
                    <input
                      type="checkbox"
                      class="w-4 h-4 text-[#00B307] bg-gray-100 rounded-lg border-gray-300 focus:ring-[#00B307]  focus:ring-2"
                    />
                  </td>
                  <td>
